...
procedure AARM_2012_CH04 is
   ...
   package Section_4_3_4_Paragraph_22 is
      ...
      function Translate (P : Point'Class; X, Y : Float) return Point'Class is
              ...
              -- A reduction expression that outputs the sum of squares:
                ...
                Put_Line ("Sum of Squares is" &
                   ...
                   'Reduce("+", 0.0));
                                               ...
                                               package Section_4_9_Paragraph_26b is
                                               ...
                                               X3 : constant := If_Then_Else (True, 37, 1 / 0);
                                               ...
                                               X2   : Float            := Float'(1.0E+400) + 1.0 - Float'(1.0E+400);
